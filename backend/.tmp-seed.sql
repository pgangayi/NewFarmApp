...
DELETE FROM audit_logs WHERE user_id = 'e2e-test-user-1';
...
VALUES ('e2e-test-user-1', 'e2e+user@example.com', 'E2E User', '$2a$10$zcaT0k3bgR0migy6vrTPauKvHkRrhjC4OASmJqdlN1Vfh9GhL5TiW', datetime('now'), datetime('now'));
