...
test.describe('Authentication Flow - Simplified', () => {
  ...
  test('should display login form elements', async ({ page }) => {
    ...
    const emailInputs = page.locator('input[type="email"], input[placeholder*="email"], input[id*="email"]').first();
    const passwordInputs = page.locator('input[type="password"], input[placeholder*="password"], input[id*="password"]').first();
