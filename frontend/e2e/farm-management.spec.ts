...
test.describe('Farm Management', () => {
  ...
  test('should display search functionality', async ({ page }) => {
    ...
    const searchInputs = page.locator('input[type="search"], input[placeholder*="search"], .search-input');
  ...
  test('should create new farm successfully', async ({ page }) => {
    ...
    const submitButtons = page.locator('button[type="submit"], button:has-text("Create"), button:has-text("Save")');
  ...
  test('should close create farm modal', async ({ page }) => {
    ...
    const closeButtons = page.locator('button:has-text("Close"), button:has-text("Cancel"), .close, [aria-label="Close"]');
